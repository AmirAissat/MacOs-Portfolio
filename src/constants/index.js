...
const techStack = [
    ...
    {
        category: "Frontend",
        items: ["React.js", "Next.js", "TypeScript", "Three.js"],
    },
    {
        category: "Mobile",
...
const socials = [
    {
        id: 1,
        text: "Github",
        icon: "public/public/icons/github.svg",
        bg: "#f4656b",
    ...
    },
    {
        id: 2,
        text: "Platform",
        icon: "public/public/icons/atom.svg",
        bg: "#4bcb63",
    ...
    },
    {
        id: 3,
        text: "Twitter/X",
        icon: "public/public/icons/twitter.svg",
        bg: "#ff866b",
    ...
    },
    {
        id: 4,
        text: "LinkedIn",
        icon: "public/public/icons/linkedin.svg",
        bg: "#05b6f6",
...
const WORK_LOCATION = {
    ...
    type: "work",
    name: "Projects",
    icon: "public/public/icons/work.svg",
    kind: "folder",
    children: [
        // ▶ Project 1
        {
            ...
            icon: "public/public/images/folder.png",
            kind: "folder",
            ...
            children: [
                {
                    ...
                    icon: "public/public/images/txt.png",
                    kind: "file",
                    fileType: "txt",
                ...
                },
                {
                    id: 2,
                    name: "nike.com",
                    icon: "public/public/images/safari.png",
                    kind: "file",
                    fileType: "url",
                ...
                },
                {
                    id: 5,
                    name: "Design.fig",
                    icon: "public/public/images/plain.png",
                    kind: "file",
                    fileType: "fig",
...
const ABOUT_LOCATION = {
    ...
    type: "about",
    name: "About me",
    icon: "public/public/icons/info.svg",
    kind: "folder",
    children: [
        {
            id: 1,
        ...
        },
        {
            ...
            image: "public/public/images/adrian.jpg",
            description: [
...
const RESUME_LOCATION = {
    ...
    type: "resume",
    name: "Resume",
    icon: "public/public/icons/file.svg",
    kind: "folder",
    children: [
        {
            id: 1,
            name: "Resume.pdf",
            icon: "public/public/images/pdf.png",
            kind: "file",
            fileType: "pdf",
...
const TRASH_LOCATION = {
    ...
    type: "trash",
    name: "Trash",
    icon: "public/public/icons/trash.svg",
    kind: "folder",
    children: [
        {
            id: 1,
